...
class Scoreboard:
    ...
    def prep_high_score(self):
        """Turn the high score into a rendered time"""
    ...
    def prep_level(self):
        ...
        # Position the level below the aliens shot
        self.level_rect = self.level_image.get_rect()
        self.level_rect.right = self.score_rect.right
        self.level_rect.top = self.aliens_shot_rect.bottom + 10

    def prep_aliens_shot(self):
        """Turn the aliens shot into a rendered image"""

        aliens_shot_str = f"Aliens Shot: {self.stats.aliens_shot}"
        self.aliens_shot_image = self.font.render(aliens_shot_str, True,
                                self.text_color, self.settings.bg_color)
        
        # Position the aliens shot below the score
        self.aliens_shot_rect = self.aliens_shot_image.get_rect()
        self.aliens_shot_rect.right = self.score_rect.right
        self.aliens_shot_rect.top = self.score_rect.bottom + 10
